...
namespace MetaverseUIContent.Views
{
    ...
    /// </summary>
    public sealed partial class TeachingTipPage : Page, SubPage
    {
        public string header => "Teaching Tip";
        ...
        public void teachingTipDownload(object sender, RoutedEventArgs e)
        {
            wnd.pickDownloadLocation("ms-appx:///Assets/Unity Assets/TeachingTip.unitypackage", "TeachingTipAsset.unitypackage");
        }
