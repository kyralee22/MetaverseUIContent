...
namespace MetaverseUIContent.Views
{
    ...
    /// </summary>
    public sealed partial class SliderPage : Page, SubPage
    {
        public string header => "Slider"; 
        ...
        public void sliderDownload(object sender, RoutedEventArgs e)
        {
            wnd.pickDownloadLocation("ms-appx:///Assets/Unity Assets/Slider.unitypackage", "SliderAsset.unitypackage");
        }
    }
}
