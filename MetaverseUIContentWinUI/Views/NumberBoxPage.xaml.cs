...
namespace MetaverseUIContent.Views
{
    ...
    /// </summary>
    public sealed partial class NumberBoxPage : Page, SubPage
    {
        public string header => "Number Box";
        ...
        public void numberBoxDownload(object sender, RoutedEventArgs e)
        {
            wnd.pickDownloadLocation("ms-appx:///Assets/Unity Assets/NumberBox.unitypackage", "NumberBoxAsset.unitypackage");
        }
    }
}
