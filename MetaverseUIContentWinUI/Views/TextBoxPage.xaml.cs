...
namespace MetaverseUIContent.Views
{
    ...
    /// </summary>
    public sealed partial class TextBoxPage : Page, SubPage
    {
        public string header => "Text Box";
        ...
        public void textBoxDownload(object sender, RoutedEventArgs e)
        {
            wnd.pickDownloadLocation("ms-appx:///Assets/Unity Assets/TextBox.unitypackage", "TextBoxAsset.unitypackage");
        }
    }
}
