...
namespace MetaverseUIContent.Views
{
    ...
    /// </summary>
    public sealed partial class FlipViewPage : Page, SubPage
    {
        public string header => "Flip View";
        ...
        public void flipViewDownload(object sender, RoutedEventArgs e)
        {
            wnd.pickDownloadLocation("ms-appx:///Assets/Unity Assets/FlipView.unitypackage", "FlipViewAsset.unitypackage");
        }
    }
}
